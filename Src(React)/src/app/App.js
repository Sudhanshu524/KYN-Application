...
import TermsCon from '../user/terms/Terms&Con';
        ...
        <div className="app-body">
          <Switch>
            ...
            <PrivateRoute path="/profile" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              ...
              <PrivateRoute path="/terms" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              component={TermsCon}></PrivateRoute>
            <Route path="/login"
